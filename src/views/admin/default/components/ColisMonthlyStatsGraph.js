...
const ColisMonthlyStatsGraph = () => {
  ...
  return (
    <Box>
      <Heading size="md" mb={2} textAlign="center">Colis Created Each Day This Month</Heading>
      <VictoryChart height={200} padding={{ top: 20, bottom: 50, left: 50, right: 20 }}>
        ...
        />
        <VictoryAxis dependentAxis label="Number of Colis" style={{ axisLabel: { padding: 35 ,fontSize : 8} }} />
        <VictoryBar
          data={colisStats}
          x="month_day"
          y="count"
